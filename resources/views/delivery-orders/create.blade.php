            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('delivery-orders.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="do_number" name="do_number" type="text" class="mt-1 block w-full" :value="old('do_number')" required autofocus />
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="delivery_address" name="delivery_address" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>{{ old('delivery_address') }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="scheduled_delivery" name="scheduled_delivery" type="date" class="mt-1 block w-full" :value="old('scheduled_delivery')" required />
